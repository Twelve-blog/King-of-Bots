                            ...
                            <div class="modal-dialog modal-xl">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label for="add-bot-description" class="form-label">代码</label>
                                            <VAceEditor
...
export default {
    ...
    ace.config.set(
        ...
        const refresh_bots = () => {
            $.ajax({
                url: "https://app2740.acapp.acwing.com.cn/api/user/bot/getlist/",
                type: "get",
                headers:{
        ...
        const add_bot = () => {
            ...
            $.ajax({
                url: "https://app2740.acapp.acwing.com.cn/api/user/bot/add/",
                type: "post",
                data: {
                    title: botadd.title,
        ...
        const remove_bot = (bot) => {
            $.ajax({
                url: "https://app2740.acapp.acwing.com.cn/api/user/bot/remove/",
                type: "post",
                data: {
                    bot_id: bot.id,
                },
        ...
        const updata_bot = (bot) => {
            botadd.error_message = "";
            $.ajax({
                url: "https://app2740.acapp.acwing.com.cn/api/user/bot/update/",
                type: "post",
                data: {
                    bot_id: bot.id,
                    title: bot.title,
